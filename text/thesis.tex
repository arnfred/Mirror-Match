...
and next \emph{MMC} and \emph{MM} applied to near duplicate detection.
...
using \emph{Ratio} to match images. For comparison, the performance 
improvement of \emph{PhotoCluster} compared to XMatch 
