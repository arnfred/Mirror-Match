...
\tableofcontents
%\addcontentsline{toc}{chapter}{List of figures} % adds an entry to the 
%table of contents
%\listoffigures
%\addcontentsline{toc}{chapter}{List of tables} % adds an entry to the 
%table of contents
%\listoftables
...
\include{main/ch2_background}
\include{main/ch3_matching_methods}
%\include{main/ch4_competition}
\include{main/ch5_experiments}
\include{main/ch6_applications}
\include{main/ch7_summary}
