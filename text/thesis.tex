...
\begin{figure}[h]
	\begin{subfigure}[t]{0.8\columnwidth}
		\centering
		\includegraphics[width=\columnwidth]{images/pano_narrow}
	...
	\begin{subfigure}{0.4\columnwidth}
		\includegraphics[width=\columnwidth]{images/panorama-autostitch}
	...
	%(or a blank line to force the subfigure onto a new line)
	\begin{subfigure}{0.4\columnwidth}
		\includegraphics[width=\columnwidth]{images/panorama-MMC}
		\caption{Panorama by MMC}
		\label{fig:pano_MMC}
	\end{subfigure}%
	\caption{An example of a difficult case of panorama recognition and 
