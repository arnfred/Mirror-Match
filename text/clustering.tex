...
%Given two sets of feature points, $A$ and $B$ corresponding to two 
%images $i_A$ and $i_B$, and a feature point $f_A^i$ in set $A$ is more 
%closely related to one or more other feature points in set $A$ than 
%feature points in set $B$ then the potential matches between $f_A^i$ 
%and feature points in $B$ is deemed \emph{unreliable}.
